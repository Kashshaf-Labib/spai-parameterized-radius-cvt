...
physics-informed frequency masking for medical AI-generated image detection. Instead of
the hard-coded `r = 16`, the masking radius becomes a differentiable parameter that is
learned during fine-tuning. See
